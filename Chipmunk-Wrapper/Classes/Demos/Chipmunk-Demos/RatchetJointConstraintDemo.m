...
#import "RatchetJointConstraintDemo.h"
...
@interface RatchetJointConstraintDemo ()
...
@implementation RatchetJointConstraintDemo
...
- (void) initializeChipmunkObjects {
	...
	CMConstraint *ratchetJointConstraint = [body1 addRatchetJointConstraintWithBody:body2 phase:0.0f ratchet:M_PI_2];
	[ratchetJointConstraint addToSpace];
}
